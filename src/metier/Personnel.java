...
public class Personnel {
	 ...
	 * LocalDate date_naissance, String lieu, Role role, Service service){ this.nom
	 * = nom; this.prenom = prenom; this.adresse = adresse; //initialisation de la
	 * variable login par défaut = 1ere Lettre du Prénom et Nom this.login =
	 * prenom.substring(0, 1)+nom; //initialisation de la variable mail par défault
	 * = login+@+nom_dom_ent+.com this.mail = login+"@"+/*entreprise
	 *//*
		 * ".com"; this.tel = tel; this.date_naissance = date_naissance;
		 * this.localisation = localisation; this.role = role; this.service = service;
		 * 
		 * //initialisation de la variable statut par défault en hors_ligne this.statut
		 * = new Statut("hors_ligne");
		 * 
		 * }
		 */
	...
	public String toString() {
		return "Personnel [statut=" + statut + ", role=" + role + ",service=" + service + ",nom=" + nom + ",mail="
				+ mail + ",tel=" + tel + ",login=" + login + ",date_naissance=" + date_naissance + ",localisation="
				+ localisation + "mdp=" + mdp + "]";
	}
